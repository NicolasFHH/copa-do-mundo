...
public class DadosHistoricos {
	...
	public DadosHistoricos(String nome, int participacoes, int pontos, int jogos, int vitorias, int empates,
	...
	public int compraraDados(DadosHistoricos desafiante, int comparador) {
